	...
	namespace NSTrivialTensor
	{
		...
		public:
			...
			EvalItem(TScalarHandle p_scalar,TOutputHandle resBuf,Shape<uDim> p_shape)
				:BaseEvalItem(TypeID<EvalItem>(),{p_scalar.DataPtr()},resBuf.DataPtr())
		...
		protected:
			virtual void EvalInternalLogic(EvalItemType& evalItem) final override
			{
				...
				static_assert(std::is_same_v<DeviceTypeFromHandle<TOutputHandle>, DeviceTags::CPU>, "Currently only CPU issupported.");
