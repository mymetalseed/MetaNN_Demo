...
namespace MetaNN
{
	...
	class DynamicWrapper :public DynmaicBase<typename TInternalData::ElementType,
		...
		typename TInternalData::CategoryTag>
	{
		using TBase = DynamicBase<typename TInternalData::ElementType,
			typename TInternalData::DeviceType, typename TInternalData::CategoryTag>;
	...
	public:
		...
		DynamicConstEvalHandle<typename TBase::EvalData> EvalRegister() const override final {
