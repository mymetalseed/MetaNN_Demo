...
namespace MetaNN {
	namespace NSScalableTensor {
		...
		public:
			...
			EvalItem(std::vector<TInputHandle> p_input, TOutputHandle p_output, std::set<const void*> p_dependencies, Shape<uDim> p_outputShape)
		...
		protected:
			virtual void EvalInternalLogic(EvalItemType& evalItem) final override {
				using ResType = typename TOutputHandlle::DataType;
	...
	public:
		...
		template <typename... TShapeParameter,std::enable_if_t<(std::is_convertible_v<TShapeParameter,size_t>&& ...)>* = nullptr>
